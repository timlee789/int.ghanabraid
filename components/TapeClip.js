...
function TapeClip()  {
  ...
  return (
    <div className={cla.main}>  
       ...
       <div className={cla.phototitle_highness}>Soprano Hair Extesions</div>
    <div className={cla.album_highness}>
    <div className={cla.box} >
           <Image src='https://bijouxhair.com/tim/landing2/highness1.jpg' alt='banner' width='800px' height='960px' className={cla.image}/>
           <div className={cla.videotitle}>Soprano Virgin Remi Hair Clip</div>
     </div>
     </div>
     <div className={cla.album_highness}>
     <div className={cla.box} >
           <Image src='https://bijouxhair.com/tim/landing2/highness2.jpg' alt='banner' width='800px' height='960px' className={cla.image}/>
           <div className={cla.videotitle}>Soprano Virgin Remi Hair Clip</div>
     </div>
     </div>
    <div className={cla.album_highness}>
    <div className={cla.box} >
           <Image src='https://bijouxhair.com/tim/landing2/highness3.jpg' alt='banner' width='800px' height='960px' className={cla.image}/>
           <div className={cla.videotitle}>Soprano Virgin Remi Hair Clip</div>
     </div>
     </div>
    <div className={cla.album_highness}>
